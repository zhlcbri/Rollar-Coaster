...
OBJObject::OBJObject(const char *filepath)
{
    ...
    cubemapTexture1 = loadCubemap(faces);
...
//    M = glm::rotate(glm::mat4(1.0f), sin(1.0f), glm::vec3(1.0f, 0.0f, 0.0f)) * M;
...
unsigned int OBJObject::loadCubemap(vector<string> faces)
{
